...
export default function LoginPage() {
  return (
    <div className="flex flex-col sm:rounded-lg items-center justify-center gap-y-6 bg-black sm:min-w-xl w-full sm:w-fit h-[100dvh] sm:h-[calc(100vh-10rem)] px-6 relative overflow-hidden">
